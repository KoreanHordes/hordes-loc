export default {
  interactions: [{
    ...
    text: {
      ...
      ko: '블랙스미스의 축복이 담긴 망치와 같은 장비가 없으면 업그레이드가 위험하므로 업그레이드하는 동안 아이템이 손상되는 것을 방지 할 수 있습니다. 망치가 없으면 장비가 위험할것입니다, 제가 당신을 위해 해드릴수 있는게 있을까요?',
      ...
      pt: 'Atualizar é arriscado sem itens especiais como o Blacksmith\'s Blessed Hammer, ele pode evitar que itens quebrem durante as atualizações. Sem o martelo, estaremos correndo um risco. Então, certamente você tem algo que eu possa atualizar para você hoje?',
